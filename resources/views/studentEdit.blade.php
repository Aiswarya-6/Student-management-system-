...
<body>
    ...
    <form action="{{ url('student/update', ['studentId' => $student->id])  }}" method="post">
        @csrf
        <table class="table-bordered">
     
            <tr>
                <th>Name</th>
                <td><input type="text" name="Name" id="" required value="{{$student->Name}}"></td>
            </tr>
            <tr>
                <th>Age</th>
                <td><input type="number" name="Age" id="" required value="{{$student->Age}}"></td>
            </tr>
            <tr>
                <th>Gender</th>
            ...
            <tr>
                ...
                <td><select name="ReportingTeacherId" id="" required value>
                        @foreach($teacher as $data)
                    
                        <option value="{{ $data->id }}" {{ $student->ReportingTeacherId == $data->id ? 'selected' : '' }}>
                            {{$data->ReportingTeacher}}
                        </option>
                        @endforeach
